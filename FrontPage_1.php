...
<!--best to eventually have images on the Website-->
	.small {
		background-image:url('/Website_Genesis/Oceans_Google.jpg'); background-size:100% 100%;
...
height:200px; width:600px;"> 
	...
	<img src="http://localhost/website_genesis/SocialTradeLogo.jpg" alt="FrontPage_Logo" border="3" height="120" max-height="120"  />	
    </div>
...
<form method="post"	action="/Website_Genesis/Post_NewMember.php" style="display:inline-block;margin-left:200px;">
	<div style="display:block">
