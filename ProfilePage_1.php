...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta 
			...
			name="Description" 
			content="This site is a Member's Profile Page to trade skills and start interest groups" />
	...
	<!--	CSS STYLING	-->
		<link 
			href="/WebDevelopment/SocialWorkflow/ExternalStyling_CSS.css" 
			rel="stylesheet" 
			type="text/css" />
	...
	<body>
		...
		<!--	TITLE OF PAGE	-->
			<div 
				style= "display:inline-block; position:relative; margin-left:15px; top:0; left:0; 
				padding:10px 20px 10px 10px; border:2px solid red;  background-color:#09F; 
				color:#FC6; border-radius:0px; height:140px; width:600px;"> 
				<div style= "display:inline-block; margin:10px auto 10px 10px; position:absolute; ">
				
					<img 	src="WebDevelopment/SocialWorkflow/Images/socialtradelogo.jpg"
							alt="FrontPage_Logo" height="100">
							<!--border=2-->
				</div>
				<!-- Go to Profile Page	-->
				<div 
					style="display:inline-block; position:absolute; top:50px; left:200px; padding: 
						10px; width:200px; margin:auto;">
		...
		<div style="position:relative; display:block; width:50%;">
			<a id="Top"></a>
			<div 
			style=	"position:relative; display:block; width:450px; margin-top:2px; 
				...
				<div style='display:block; position:relative; top:30px; width:50%;'>
					<video 
						...
						width=200px>
						<source 
							src="/WebDevelopment/SocialWorkflow/testing_video_genesis.m4v" 
							type="video/mp4" >
						<source 
							src="/WebDevelopment/SocialWorkflow/testing_video_genesis.ogg" 
							type="video/ogg" >
						<source 
							src="/WebDevelopment/SocialWorkflow/testing_video_genesis.webm" 
							type="video/webm" >
						<source 
							src="/WebDevelopment/SocialWorkflow/testing_video_genesis.mp4" 
							type="video/mp4" >
		...
		<div 
			style='display:inline-block; width:50%; left:500px; position:relative; margin-top:2px; 
				margin-left:15px;'>
			<h4 style='display:block; position:relative; margin-top:0px;'>Background:</h4>
				<div 
					style="display:block; position:absolute; top:30px; padding:2px; 
						background-color:#FFC; border:2px dashed #FF3366; width:400px;">
					<div 
						style="display-background:#FFF; border:1px solid red; top:5px; left:520px; 
							width:90%;">
						<div style='margin:4px;'>
						<!-- This needs to come from database -->
						<script>
							var 
								Name = "I'm an experienced gardener with 6 years professional experience in horticulture, and looking for the occasional weekend work."; 
								// Dossier about me from database
